...
const COMMENTS = [...Array(8)].map((_, index) => ({
  ...
  message:
    (index === 3 && _mock.image.feed(6)) || (index === 5 && _mock.image.feed(8)) || _mock.text.sentence(index)
}));
...
const cardList = [
  {
    ...
    assignee: [{ id: memberIds.member1, avatar: _mock.image.avatar(1), name: _mock.name.fullName(1) }],
  ...
  },
  {
    ...
    due: [addDays(now, 6).getTime(), addDays(now, 7).getTime()],
    attachments: [_mock.image.feed(1)],
    comments: [],
    completed: false
  },
  {
  ...
  },
  {
    ...
    due: [null, null],
    attachments: [_mock.image.feed(3)],
    comments: [],
    completed: false
  },
  {
    ...
    assignee: [{ id: memberIds.member1, avatar: _mock.image.avatar(1), name: _mock.name.fullName(9) }],
    due: [null, null],
    attachments: [],
    comments: [],
    completed: true
  },
  {
    ...
    assignee: [{ id: memberIds.member1, avatar: _mock.image.avatar(1), name: _mock.name.fullName(10) }],
    due: [null, null],
    attachments: [],
    comments: [],
    completed: true
